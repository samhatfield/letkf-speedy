...
!****************************************************************
subroutine lgndre_lr(j)
    ! follows Leith Holloways code 

    use mod_atparam_lr
    use mod_spectral_lr, only: sia, coa, sqrhlf, consq, repsi, epsi, poly
...
subroutine uvspec(vorm,divm,ucosm,vcosm)
    use mod_atparam_lr
    use mod_spectral_lr, only: uvdx, uvdyp, uvdym
...
subroutine gridy(v,varm)
    use mod_atparam_lr
    use mod_spectral_lr, only: cpol, nsh2
