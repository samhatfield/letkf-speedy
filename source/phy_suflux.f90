subroutine suflux (psa,ua,va,ta,qa,rh,phi,phi0,fmask,tland,tsea,swav,ssrd,slrd,&
    ...
    if (lfluxland)  then
        ...
        ! 2.5 Evaporation
        if (fhum0.gt.0.) then
            call shtorh(-1,ngp,t1(1,1),psa,1.0_dp,q1(1,1),rh(1,nlev),qsat0(1,1))
        ...
        call shtorh(0,ngp,tskin,psa,1.0_dp,qdummy,rdummy,qsat0(1,1))
        ...
        if (lskineb) then
            ...
            call shtorh(0,ngp,dtskin,psa,1.0_dp,qdummy,rdummy,qsat0(1,2))
...
!      ENDIF
        ...
        if (fhum0.gt.0.) then
            call shtorh(-1,ngp,t1(1,2),psa,1.0_dp,q1(1,2),rh(1,nlev),qsat0(1,2))
    ...
    ! 4.4 Evaporation
    call shtorh(0,ngp,tsea,psa,1.0_dp,qdummy,rdummy,qsat0(1,2))
