...
subroutine rffti1(n, wa, ifac)
  ...
  107 if (nl .ne. 1) go to 104
      ifac(1) = n
      ifac(2) = nf
      tpi = rpe_literal(8.0)*atan(rpe_literal(1.0))
      argh = tpi/n
      is = 0
      nfm1 = nf-1
      l1 = 1
...
subroutine radb3(ido, l1, cc, ch, wa1, wa2)
    ...
    !***FIRST EXECUTABLE STATEMENT  RADB3
      taur = -.5
      taui = rpe_literal(0.5)*sqrt(rpe_literal(3.0))
      do 101 k=1,l1
...
subroutine radb5(ido, l1, cc, ch, wa1, wa2, wa3, wa4)
    ...
    !***First executable statement  radb5
      pi = rpe_literal(4.0)*atan(rpe_literal(1.0))
      tr11 = sin(rpe_literal(0.1)*pi)
      ti11 = sin(rpe_literal(0.4)*pi)
      tr12 = -sin(rpe_literal(0.3)*pi)
      ti12 = sin(rpe_literal(0.2)*pi)
      do 101 k=1,l1
...
subroutine radf4(ido, l1, cc, ch, wa1, wa2, wa3)
    ...
    !***First executable statement  radf4
      hsqt2 = rpe_literal(0.5)*sqrt(rpe_literal(2.0))
      do 101 k=1,l1
